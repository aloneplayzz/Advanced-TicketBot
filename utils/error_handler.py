...
class GlobalErrorHandler(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingPermissions):
            ...
            embed = self.create_error_embed(
                ...
                f" Please ask an administrator to grant me these permissions.",
                "bot_permission"
            )
            ...
            embed = self.create_error_embed(
                ...
                f" This is a developer command and cannot be used by regular users.",
                "permission"
            )
            ...
            embed = self.create_error_embed(
                ...
                f" Please use this command in an appropriate channel.",
                "validation"
            )
            ...
            embed = self.create_error_embed(
                ...
                f" Please check my permissions and try again.\n\n"
            ...
            embed = self.create_error_embed(
                ...
                f" This might be a deleted channel, message, or user.\n\n"
                f"**Details:** {str(error)}",
                "not_found"
            )
            ...
            embed = self.create_error_embed(
                ...
                f" Our team has been notified and will fix this soon.\n\n"
    ...
    async def on_app_command_error(self, interaction: discord.Interaction, error: discord.app_commands.AppCommandError):
        ...
        if isinstance(error, discord.app_commands.MissingPermissions):
            ...
            embed = self.create_error_embed(
                ...
                f" Contact an administrator to get the required role.",
                "permission"
            )
    ...
    async def handle_view_error(self, interaction: discord.Interaction, error: Exception, error_type: str = "general"):
        ...
        embed = self.create_error_embed(
            ...
            f" Please try again or refresh the interface.\n\n"
            f"**Error:** {str(error)[:200]}{'...' if len(str(error)) > 200 else ''}",
            error_type
        )
    ...
    async def handle_database_error(self, ctx, error: Exception):
        ...
        embed = self.create_error_embed(
            ...
            f" This is usually temporary and resolves quickly.\n\n"
            f" Please try again in a moment.",
            "database"
        )
